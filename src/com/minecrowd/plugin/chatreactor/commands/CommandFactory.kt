...
import com.minecrowd.plugin.chatreactor.commands.impl.animals.Wolves
...
object CommandFactory {
    ...
    private val commandList = listOf(
        ...
        NightVision, Roll, Cat, ToTheEnd, Horse, TimeShift, GoldenShovel, Trident, WhatIsThat, Parkour, BrokenXray, Elytra, Wolves
    )
